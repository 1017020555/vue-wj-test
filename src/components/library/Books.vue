<template>
  <div>
    <el-row style="height: 540px;">
        ...
        <el-tooltip  effect="dark"  placement="right" v-for="book in books" v-bind:key="book.id">
          ...
          <el-card style="height: 233px;width: 135px;float: left;margin-bottom: 20px;margin-left: 15px;padding: 10px;" class="book"
